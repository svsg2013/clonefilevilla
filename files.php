...
$desc=$_GET['txtDes'];
//price
$smallPrice= $_GET['smallList'];
$bigPrice= $_GET['bigList'];
//---end prices
//other color
$other= $_GET['txtOther'];
$slug= changeTitle($title);
function SmallPrice(){
    if (isset($_GET['smallList'])){
        return $_GET['smallList'];
    }
}
function BigPrice(){
    if (isset($_GET['bigList'])){
        return $_GET['bigList'];
    }
}
$getSmall= SmallPrice();
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-6 wrapper_item">
                                <div class="product__content__item">
                                    <div class="product__content__item__image">
                                        ...
                                        <a href="/cement-tile/instock/amalena-boardwalk"><img src="/images/Instock-List-Product/listing/amalena-boardwalk-cement-tile-210b.jpg" alt="'.$name.'"></a>
                                    </div>
                                    <p class="product__content__item__caption">
                                        <a href="/cement-tile/instock/amalena-boardwalk">'.$name.'</a>
                                    </p>
                                </div>
                            </div>
                ';
                    ...
                    <div class="col-md-6">
                        <div class="product-detail__desc-product">
                            ...
                            <div class="product-detail__desc-product__des">
                                <p><span class="title--bold price">$'.$getSmall.'</span><span class="title--bold"> /Piece </span>($'.$getBig.' / square foot)</p>
                                    ...
                                    <li class="tabs__item"><h4>detail pricing <i class="icon_plus"></i></h4>
                                        <div class="sub-tab">
                                            ...
                                            <div class="sub-tab__text">
                                                <ul class="row">
                                                    <li class="col-lg-6"><i class="arrow_carrot-right"></i><span>Standard Price</span><span class="title--bold">$'.$getSmall.'</span></li>
                                                    <li class="col-lg-6"><i class="arrow_carrot-right"></i><span>square foot</span><span class="title--bold">$'.$getBig.'</span></li>
...
';
$html.='<?php include $_SERVER[\'DOCUMENT_ROOT\'].\'/template/footer.php\'; ?>';
//--------------khúc này xử lý dữ liệu file bên trên
$valid= saveFiles($slug,$html);
if ( $valid == 1){
    echo "<tr><td><br/>File đã được lưu<br/><br/></td></tr>";
} else if ($valid == -2){
    echo "<tr><td><br/>Sảy ra lỗi trong quá trình lưu file<br/><br/></td></tr>";
} else if ($valid == -1){
    echo "<tr><td><br/>Sai tên file<br/><br/></td></tr>";
}
?>
<html>
<body>
<input type="button" onclick="ClickToBack()" value="Quay trở lại" class="goToBack"/>
