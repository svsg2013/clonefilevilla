                    ...
                    <div class="col-md-6">
                        <div class="product-detail__desc-product">
                            ...
                            <div class="product-detail__desc-product__des">
                                <p><span class="title--bold price">$6.24</span><span class="title--bold"> /Piece </span>($16.77 / square foot)</p>
                                <p class="description" itemprop="description">
                                    sldjflkasdjfklasjdklfj
                                </p>
                                <ul>
                                    <li>Size - <b>8”</b></li>
                            ...
                            <div class="product-detail__desc-product__readmore">
                                <ul class="tabs">
                                    <li class="tabs__item"><h4>detail pricing <i class="icon_plus"></i></h4>
                                        <div class="sub-tab">
                                            <h5 class="title--bold">"Carmen A Hermosa", Lot SB-D03, In Stock</h5>
                                            <div class="sub-tab__text">
                                                <ul class="row">
                                                    ...
                                                    <li class="col-lg-6"><i class="arrow_carrot-right"></i><span>square foot</span><span class="title--bold">16.77</span></li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="product__title clearfix">
                            <div class="row">
                                <div class="col-md-6 product__title__text">
                                    <h3 class="title--bold">Other Color</h3>
                                </div>
                            </div>
                        </div>
                        <div class="product__content row">
    
                            <div class="col-md-3 col-sm-4 col-xs-6 wrapper_item">
                                <div class="product__content__item">
                                    <div class="product__content__item__image">
                                        <span class="sale">sale</span>
                                        <a href="/cement-tile/instock/amalena-boardwalk"><img src="/images/Instock-List-Product/listing/amalena-boardwalk-cement-tile-210b.jpg" alt="fdgffdfgfgfgfg"></a>
                                    </div>
                                    <p class="product__content__item__caption">
                                        <a href="/cement-tile/instock/amalena-boardwalk">fdgffdfgfgfgfg</a>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-6 wrapper_item">
                                <div class="product__content__item">
                                    <div class="product__content__item__image">
                                        <span class="sale">sale</span>
                                        <a href="/cement-tile/instock/amalena-boardwalk"><img src="/images/Instock-List-Product/listing/amalena-boardwalk-cement-tile-210b.jpg" alt="fdsgdsfgsdfgsdfgsdfgdfsg"></a>
                                    </div>
                                    <p class="product__content__item__caption">
                                        <a href="/cement-tile/instock/amalena-boardwalk">fdsgdsfgsdfgsdfgsdfgdfsg</a>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-6 wrapper_item">
                                <div class="product__content__item">
                                    <div class="product__content__item__image">
                                        <span class="sale">sale</span>
                                        <a href="/cement-tile/instock/amalena-boardwalk"><img src="/images/Instock-List-Product/listing/amalena-boardwalk-cement-tile-210b.jpg" alt="sfgsdfgsdfgsfgdsfg"></a>
                                    </div>
                                    <p class="product__content__item__caption">
                                        <a href="/cement-tile/instock/amalena-boardwalk">sfgsdfgsdfgsfgdsfg</a>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-6 wrapper_item">
                                <div class="product__content__item">
                                    <div class="product__content__item__image">
                                        <span class="sale">sale</span>
                                        <a href="/cement-tile/instock/amalena-boardwalk"><img src="/images/Instock-List-Product/listing/amalena-boardwalk-cement-tile-210b.jpg" alt="sfgdsfgdsfgfdsgsdfg"></a>
                                    </div>
                                    <p class="product__content__item__caption">
                                        <a href="/cement-tile/instock/amalena-boardwalk">sfgdsfgdsfgfdsgsdfg</a>
                                    </p>
                                </div>
                            </div>
