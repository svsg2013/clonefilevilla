                    ...
                    <div class="col-md-6">
                        <div class="product-detail__desc-product">
                            ...
                            <div class="product-detail__desc-product__des">
                                <p><span class="title--bold price">$7.29</span><span class="title--bold"> /Piece </span>($16.77 / square foot)</p>
                                    ...
                                    <li class="tabs__item"><h4>detail pricing <i class="icon_plus"></i></h4>
                                        <div class="sub-tab">
                                            ...
                                            <div class="sub-tab__text">
                                                <ul class="row">
                                                    <li class="col-lg-6"><i class="arrow_carrot-right"></i><span>Standard Price</span><span class="title--bold">$7.29</span></li>
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-6 wrapper_item">
                                <div class="product__content__item">
                                    <div class="product__content__item__image">
                                        ...
                                        <a href="/cement-tile/instock/amalena-boardwalk"><img src="/images/Instock-List-Product/listing/amalena-boardwalk-cement-tile-210b.jpg" alt="amalena-meadow"></a>
                                    </div>
                                    <p class="product__content__item__caption">
                                        <a href="/cement-tile/instock/amalena-boardwalk">amalena-meadow</a>
                                    </p>
                                </div>
                            </div>
